...
var RxCookieJar_1 = require("./RxCookieJar");
/**
 * Class definition
 */
var RxHttpRequest = /** @class */ (function () {
    ...
    RxHttpRequest.prototype.jar = function () {
        return rxjs_1.of(new RxCookieJar_1.RxCookieJar(this._request.jar()));
    };
    /**
            ...
            rxjs_1.of([].concat(uri, Object.assign({}, options || {}), (function (error, response, body) {
                rxjs_1.of(rxjs_1.of(error))
                    ...
                    return rxjs_1.merge(obsError
                        ...
                        .pipe(operators_1.filter(function (_) { return !_; }), operators_1.flatMap(function (_) {
                        return !!response ?
                            rxjs_1.of(response) :
                    ...
                    }), operators_1.tap(function (_) { return observer.next(_); }), operators_1.tap(function (_) { return observer.complete(); })));
                }))
                    .subscribe(undefined, function (err) { return observer.error(err); });
            })))
